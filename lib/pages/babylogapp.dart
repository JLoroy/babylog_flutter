    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Stack(children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            currentAssistant.name ?? "Baby",
                            textAlign: TextAlign.start,
                            style: TextStyle(
                                fontStyle: FontStyle.normal, fontSize: 24),
                          ),
                          Text("Babylog Assistant",
                              style:
                                  TextStyle(letterSpacing: 1.5, fontSize: 12)),
                        ],
                      ),
                    ),
                    Padding(
          ...
          if (currentAssistant.byok == true || currentAssistant.usage! > 0)
            Positioned(
              left: 0,
              right: 0,
              bottom: 0,
                            ...
                            child: showPlayer
                                ...
                                : AudioRecorderWidget(
                                    onStop: (path) {
                                      ...
                                      transcribeAudio(currentAssistant, path,
                                          _changeText, resetRecord);
                                      setState(() {
                                        audioPath = path;
                                        showPlayer = true;
                                      });
