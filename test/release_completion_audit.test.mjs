...
test('release completion audit tracks objective evidence and blockers', async () => {
  ...
  for (const required of [
    ...
    'current version-9 QA evidence run `25525502635` for commit `abe1504`',
    ...
    'audited CI `25525502635` passed Firebase rules in 26s',
    'Analyze/test in 6m34s',
    'Analyze/test in 7m44s',
    'Analyze/test in 6m40s',
    'Google SSO config validation',
    'manual QA checklist validation',
    'Play Console evidence validation',
    ...
    'retargeted to version `1.0.8+9` / version code 9',
    'email/password fallback, old-account recovery, and BYOK recording evidence before production',
