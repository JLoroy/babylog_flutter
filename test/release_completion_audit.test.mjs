...
test('release completion audit tracks objective evidence and blockers', async () => {
  ...
  for (const required of [
    ...
    'Not achieved.',
    'green remote runs including `25465179981` for commit `0c64741`',
    '`25465432676` for current tip commit `7d208b0`',
    'Latest CI `25465432676` passed Firebase rules in 40s',
    'Analyze/test in 6m21s',
