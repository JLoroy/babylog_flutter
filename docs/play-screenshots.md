...
| Shared timeline | Timeline with synthetic baby-care events and no real names. | Restart persistence / Shared assistant join | Captured in `docs/play-assets/screenshots/phone-01-shared-timeline.png` with synthetic reviewer data. Restart/shared-account evidence remains TODO. |
